...
//        cout << "Board mode set.\n";
        ...
        GPIO::setup(led_control_pin, GPIO::OUT, GPIO::LOW);             //make sure lights aren't on by default
//        cout << "Pins initialized.\n";
        if (clockwise){
            GPIO::output(direction_pin1, GPIO::LOW);                   //set direction to clockwise
            GPIO::output(direction_pin2, GPIO::HIGH);
        } else {
            GPIO::output(direction_pin1, GPIO::HIGH);                   //set direction to counter-clockwise
...
void PID::brake(int s) {
    GPIO::output(direction_pin1, GPIO::HIGH);       //setting both pins high should brake the motor
    GPIO::output(direction_pin2, GPIO::HIGH);
...
void PID::dumpText() {
    ofstream outFile;
    // ********** RPM Data txt file ***********
    outFile.open("/home/armandt/Desktop/project2021/EPR2021/ERP2021/PID/rpmData.txt", std::ios_base::app);
    ...
    // ********** RPM Data csv file ***********
    outFile.open("/home/armandt/Desktop/project2021/EPR2021/ERP2021/PID//rpmData.csv");
    outFile << "RPM,deltaT\n";
    outFile << "0.0,0.0\n";
    for (int a = 0; a < rpmHistory.size(); a++){
